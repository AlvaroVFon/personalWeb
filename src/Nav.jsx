...
export const Nav = () => {
  ...
  return (
    <>
      <nav className='hidden text-2xl font-light border-r secondary-menu justify-evenly sm:flex md:pt-3 dark:bg-primary dark:text-secondary lg:flex-col lg:justify-center lg:pl-10 lg:pb-36 lg:h-screen lg:space-y-10'>
